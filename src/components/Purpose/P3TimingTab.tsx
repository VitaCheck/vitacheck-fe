    ...
    <>
      ...
      <div className="sm:hidden">
        <div className="flex flex-col items-center px-[10px] mt-[28px] w-full h-[235px] gap-y-[24px]">
          ...
          <div className="flex justify-center items-center bg-white px-[34px] border-[#AAAAAA] border-[0.5px] rounded-[16px] w-full max-w-[356px] h-[81px]">
      ...
      <div className="hidden sm:block">
        <div className="flex flex-col items-center w-full max-w-[567px] mt-[36px]">
