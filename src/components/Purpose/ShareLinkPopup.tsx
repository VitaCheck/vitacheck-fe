// src/components/Purpose/sharelinkpopup.tsx
...
const ShareLinkPopup: React.FC<ShareLinkPopupProps> = ({ onClose, supplementUrl }) => {
  ...
  return (
    <div className="fixed inset-0 flex items-end justify-center z-50">
      <div className="bg-white h-[250px] rounded-t-4xl shadow-lg relative w-full text-center">
        <div className="px-[50px] flex flex-col items-start">
          ...
          >
            <img src="/images/PNG/MainPurpose/kakaotalk.png" alt="카카오톡이미지"
